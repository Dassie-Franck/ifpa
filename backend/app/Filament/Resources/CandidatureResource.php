                ...
                ->schema([
                    Forms\Components\Select::make('statut')
                        ->options([
                            ...
                            'dossier_valide' => 'Dossier validé (paiement reçu)',
                            'rejete' => 'Rejeté',
                    ...
                    Forms\Components\DateTimePicker::make('date_limite_paiement')
                        ...
                        ->visible(fn ($record) => $record?->statut === 'paiement_en_attente')
                        ->disabled(),
            ...
            ->actions([
                Tables\Actions\Action::make('valider')
                    ...
                    ->action(function ($record, array $data) {
                        ...
                        app(\App\Services\NotificationService::class)->notifierDossierValide($record->fresh());
                    })
